...
I didnt have the time to reproduce using CMake but here are the compilation commands that leads to exactly the same issue, generated by `build2`: [./reprocase-build.bat](./reprocase-build.bat)
